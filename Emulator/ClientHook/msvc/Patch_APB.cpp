...
void Update_EULAandTOS(char* folderLoc)
{
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"EULA.int\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"TOS.int\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"EULA.fra\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"TOS.fra\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"EULA.ger\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"TOS.ger\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"EULA.rus.int\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"TOS.rus\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"EULA.ita\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"TOS.ita\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"EULA.spa\" failed to open");
	...
	else Logger(lWARN, "Update_EULAandTOS()", "\"TOS.spa\" failed to open");
...
void Update_GameFiles(char* folderLoc)
{
	...
	else Logger(lWARN, "Update_GameFiles()", "\"EnvironmentGame.ini\" failed to open");
	...
	else Logger(lWARN, "Update_GameFiles()", "\"APBGame.ini\" failed to open");
	...
	else Logger(lWARN, "Update_GameFiles()", "\"DefaultGame.ini\" failed to open");
