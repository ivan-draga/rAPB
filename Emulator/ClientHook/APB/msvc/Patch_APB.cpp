...
void Update_EULAandTOS(char* folderLoc)
{
	...
	char str1[40] = "\\APBGame\\Localization\\INT\\EULA.int";
	strcat(loc, str1);
	FILE *file; 
	file = fopen(loc,"w");
	...
	char str2[40] = "\\APBGame\\Localization\\INT\\TOS.int";
	strcat(loc2, str2);
	FILE *file2; 
	file2 = fopen(loc2,"w");
	...
	char str3[40] = "\\APBGame\\Localization\\FRA\\EULA.fra";
	strcat(loc3, str3);
	FILE *file3; 
	file3 = fopen(loc3,"w");
	...
	char str4[40] = "\\APBGame\\Localization\\FRA\\TOS.fra";
	strcat(loc4, str4);
	FILE *file4; 
	file4 = fopen(loc4,"w");
	...
	char str5[40] = "\\APBGame\\Localization\\GER\\EULA.ger";
	strcat(loc5, str5);
	FILE *file5; 
	file5 = fopen(loc5,"w");
	...
	char str6[40] = "\\APBGame\\Localization\\GER\\TOS.ger";
	strcat(loc6, str6);
	FILE *file6; 
	file6 = fopen(loc6,"w");
	...
	char str7[40] = "\\APBGame\\Localization\\ITA\\EULA.ita";
	strcat(loc7, str7);
	FILE *file7; 
	file7 = fopen(loc7,"w");
	...
	char str8[40] = "\\APBGame\\Localization\\ITA\\TOS.ita";
	strcat(loc8, str8);
	FILE *file8; 
	file8 = fopen(loc8,"w");
	...
	char str9[40] = "\\APBGame\\Localization\\RUS\\EULA.rus";
	strcat(loc9, str9);
	FILE *file9; 
	file9 = fopen(loc9,"w");
	...
	char str10[40] = "\\APBGame\\Localization\\RUS\\TOS.rus";
	strcat(loc10, str10);
	FILE *file10; 
	...
	char str11[40] = "\\APBGame\\Localization\\SPA\\EULA.spa";
	strcat(loc11, str11);
	FILE *file11; 
	...
	char str12[40] = "\\APBGame\\Localization\\SPA\\TOS.spa";
	strcat(loc12, str12);
	FILE *file12; 
...
void Update_GameFiles(char* folderLoc)
{
	...
	char str1[40] = "\\APBGame\\Config\\EnvironmentGame.ini";
	strcat(loc1, str1);
	FILE *file; 
	file = fopen(loc1,"w");
	...
	char str2[40] = "\\APBGame\\Config\\APBGame.ini";
	strcat(loc2, str2);
	FILE *file2; 
	file2 = fopen(loc2,"w");
	...
	char str3[40] = "\\APBGame\\Config\\DefaultGame.ini";
	strcat(loc3, str3);
	FILE *file3; 
	file3 = fopen(loc3,"w");	
...
void Update_IntroMovie(char* folderLoc)
{
	...
	char loc2[1024];
	strcpy(loc2, folderLoc);
	char oldn[40] = "\\APBGame\\Movies\\IntroTitles.bik";
	char newn[40] = "\\APBGame\\Movies\\intro.bik";
	strcat(loc1, oldn);
	strcat(loc2, newn);
...
void Update_SplashScreenMovie(char* folderLoc)
{
	...
	char loc2[1024];
	strcpy(loc2, folderLoc);
	char oldn[40] = "\\APBGame\\Movies\\SplashScreen.bik";
	char newn[40] = "\\APBGame\\Movies\\splash.bik";
	strcat(loc1, oldn);
	strcat(loc2, newn);
	result = rename(loc1, loc2);
...
void Update_ShaderFile(char* folderLoc)
{
	char loc[1024];
	strcpy(loc, folderLoc);
	char str[60] = "\\Engine\\Shaders\\APBUberPostProcessBlendPixelShader.usf";
	strcat(loc, str);
	FILE *file; 
	file = fopen(loc,"w");	
...
void Update_LoadingMovie(char* folderLoc)
{
	...
	char loc2[1024];
	strcpy(loc2, folderLoc);
	char oldn[40] = "\\APBGame\\Movies\\LoadingMovieV1.bik";
	char newn[40] = "\\APBGame\\Movies\\loadingmov.bik";
	strcat(loc1, oldn);
	strcat(loc2, newn);
	result = rename(loc1, loc2);
